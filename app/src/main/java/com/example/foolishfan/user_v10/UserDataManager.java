...
//    public static final String VIBRATE = "vibrate";
    ...
    public int findUserByName(String userName) {
        ...
        int result = 0;
        Cursor mCursor = mSQLiteDatabase.query(TABLE_NAME, null, USER_NAME + "=?", new String[]{userName}, null, null, null, null);
        if (mCursor != null) {
    ...
    public int findUserByNameAndPwd(String userName, String pwd) {
        ...
        int result = 0;
        Cursor mCursor = mSQLiteDatabase.query(TABLE_NAME, null, USER_NAME + "= ? and " + USER_PWD + "= ?", new String[]{userName, pwd},
                null, null, null);
        if (mCursor != null) {
            result = mCursor.getCount();
            mCursor.close();
